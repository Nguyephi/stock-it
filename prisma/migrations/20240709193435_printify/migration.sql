...
CREATE TABLE "Printify" (
    ...
    CONSTRAINT "Printify_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Printify_userId_key" ON "Printify"("userId");
...
-- AddForeignKey
ALTER TABLE "Printify" ADD CONSTRAINT "Printify_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
